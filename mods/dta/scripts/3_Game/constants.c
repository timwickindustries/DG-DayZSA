...
const int     STAMINA_DRAIN_STANDING_SPRINT_PER_SEC = 0;
const int     STAMINA_DRAIN_CROUCHED_SPRINT_PER_SEC = 0;
const int     STAMINA_DRAIN_PRONE_SPRINT_PER_SEC = 0;
const int    STAMINA_DRAIN_SWIM_FAST_PER_SEC = 0;
const int    STAMINA_DRAIN_LADDER_FAST_PER_SEC = 0;

const float    STAMINA_DRAIN_HOLD_BREATH = 0;
const float    STAMINA_DRAIN_JUMP = 0;
const float    STAMINA_DRAIN_MELEE_LIGHT = 0;
const float    STAMINA_DRAIN_MELEE_HEAVY = 0;
const float    STAMINA_DRAIN_MELEE_EVADE = 0;
    
const int     STAMINA_GAIN_JOG_PER_SEC = 100;
const int     STAMINA_GAIN_WALK_PER_SEC = 100;
const int     STAMINA_GAIN_IDLE_PER_SEC = 100;
const int    STAMINA_GAIN_SWIM_PER_SEC = 100;
const int    STAMINA_GAIN_LADDER_PER_SEC = 100;
const float STAMINA_GAIN_BONUS_CAP = 3.0;

const float STAMINA_KG_TO_STAMINAPERCENT_PENALTY = 2.5;
const float STAMINA_MIN_CAP = 5;
const float STAMINA_SPRINT_THRESHOLD = 0;
const float STAMINA_HOLD_BREATH_THRESHOLD = 0;
const float STAMINA_JUMP_THRESHOLD = 0;
const float STAMINA_MELEE_HEAVY_THRESHOLD = STAMINA_DRAIN_MELEE_HEAVY;
const float STAMINA_MELEE_EVADE_THRESHOLD = 0;
const float STAMINA_REGEN_COOLDOWN_DEPLETION = 0;
const float STAMINA_REGEN_COOLDOWN_EXHAUSTION = 0;
const float STAMINA_WEIGHT_LIMIT_THRESHOLD = 5000;
const float STAMINA_KG_TO_GRAMS = 1000;
const float STAMINA_SYNC_RATE = 1;
